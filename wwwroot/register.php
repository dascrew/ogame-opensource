...
if (key_exists('linkuni', $_GET)) {
    echo 'registerForm.universe.value = "' . $UniList[$_GET['linkuni']]['uniurl'] . "\";\n";
}
if (key_exists('errorCode', $_GET)) {
    ...
    if ($_GET['errorCode']) {
        echo 'printMessage ("' . $_GET['errorCode'] . "\");\n";
    }
} else {
    echo "document.registerForm.character.focus();\n";
}
?>
</script>
