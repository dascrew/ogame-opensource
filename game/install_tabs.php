...
$tab_allyranks = [    // Alliance ranks
    'rank_id' => 'INT', 'ally_id' => 'INT', 'name' => 'TEXT', 'rights' => 'INT'
];

$tab_allyapps = [    // Alliance applications
...
$tab_exptab = [    // Expedition settings (can be changed in admin)
...
$tab_coltab = [    // Colonization settings (can be changed in admin)
