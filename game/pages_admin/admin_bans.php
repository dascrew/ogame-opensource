...
<?php
                        ...
                        if ($rows == 0) {
                            echo '<tr><td colspan=7>' . loca('ADM_BANS_NOT_FOUND') . " <a href=\"index.php?page=admin&session=$session&mode=Bans\">" . loca('ADM_BANS_BACK') . '</a></td></tr>';
                        }
            ...
            foreach ($_POST['id'] as $player_id => $checked) {
                ...
                switch (intval($_POST['banmode'])) {
                    case 0:
                        ...
                        $entry = [ null, $GlobalUser['oname'], $user['oname'], $GlobalUser['player_id'], $user['player_id'], $now, $now + $seconds, $reason ];
                    ...
                    case 2:
                        ...
                        break;
                    case 3: UnbanUser($player_id);
                        break;
                    case 4: UnbanUserAttacks($player_id);
                        break;
                }
            }    // for
