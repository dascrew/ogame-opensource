...
function Admin_Expedition()
{
    ...
    if (method() === 'POST') {
        ...
        if (key_exists('action', $_GET) && $_GET['action'] === 'settings') {
            ...
            if (key_exists('dm_factor', $_POST)) {
                $exptab['dm_factor'] = intval($_POST['dm_factor']);
            }

            if (key_exists('chance_success', $_POST)) {
                $exptab['chance_success'] = intval($_POST['chance_success']);
            }

            if (key_exists('depleted_min', $_POST)) {
                $exptab['depleted_min'] = intval($_POST['depleted_min']);
            }
            if (key_exists('depleted_med', $_POST)) {
                $exptab['depleted_med'] = intval($_POST['depleted_med']);
            }
            if (key_exists('depleted_max', $_POST)) {
                $exptab['depleted_max'] = intval($_POST['depleted_max']);
            }
            if (key_exists('chance_depleted_min', $_POST)) {
                $exptab['chance_depleted_min'] = intval($_POST['chance_depleted_min']);
            }
            if (key_exists('chance_depleted_med', $_POST)) {
                $exptab['chance_depleted_med'] = intval($_POST['chance_depleted_med']);
            }
            if (key_exists('chance_depleted_max', $_POST)) {
                $exptab['chance_depleted_max'] = intval($_POST['chance_depleted_max']);
            }

            if (key_exists('chance_alien', $_POST)) {
                $exptab['chance_alien'] = intval($_POST['chance_alien']);
            }
            if (key_exists('chance_pirates', $_POST)) {
                $exptab['chance_pirates'] = intval($_POST['chance_pirates']);
            }
            if (key_exists('chance_dm', $_POST)) {
                $exptab['chance_dm'] = intval($_POST['chance_dm']);
            }
            if (key_exists('chance_lost', $_POST)) {
                $exptab['chance_lost'] = intval($_POST['chance_lost']);
            }
            if (key_exists('chance_delay', $_POST)) {
                $exptab['chance_delay'] = intval($_POST['chance_delay']);
            }
            if (key_exists('chance_accel', $_POST)) {
                $exptab['chance_accel'] = intval($_POST['chance_accel']);
            }
            if (key_exists('chance_res', $_POST)) {
                $exptab['chance_res'] = intval($_POST['chance_res']);
            }
            if (key_exists('chance_fleet', $_POST)) {
                $exptab['chance_fleet'] = intval($_POST['chance_fleet']);
            }

            if (key_exists('score_cap1', $_POST)) {
                $exptab['score_cap1'] = intval($_POST['score_cap1']);
            }
            if (key_exists('score_cap2', $_POST)) {
                $exptab['score_cap2'] = intval($_POST['score_cap2']);
            }
            if (key_exists('score_cap3', $_POST)) {
                $exptab['score_cap3'] = intval($_POST['score_cap3']);
            }
            if (key_exists('score_cap4', $_POST)) {
                $exptab['score_cap4'] = intval($_POST['score_cap4']);
            }
            if (key_exists('score_cap5', $_POST)) {
                $exptab['score_cap5'] = intval($_POST['score_cap5']);
            }
            if (key_exists('score_cap6', $_POST)) {
                $exptab['score_cap6'] = intval($_POST['score_cap6']);
            }
            if (key_exists('score_cap7', $_POST)) {
                $exptab['score_cap7'] = intval($_POST['score_cap7']);
            }
            if (key_exists('score_cap8', $_POST)) {
                $exptab['score_cap8'] = intval($_POST['score_cap8']);
            }
            if (key_exists('limit_cap1', $_POST)) {
                $exptab['limit_cap1'] = intval($_POST['limit_cap1']);
            }
            if (key_exists('limit_cap2', $_POST)) {
                $exptab['limit_cap2'] = intval($_POST['limit_cap2']);
            }
            if (key_exists('limit_cap3', $_POST)) {
                $exptab['limit_cap3'] = intval($_POST['limit_cap3']);
            }
            if (key_exists('limit_cap4', $_POST)) {
                $exptab['limit_cap4'] = intval($_POST['limit_cap4']);
            }
            if (key_exists('limit_cap5', $_POST)) {
                $exptab['limit_cap5'] = intval($_POST['limit_cap5']);
            }
            if (key_exists('limit_cap6', $_POST)) {
                $exptab['limit_cap6'] = intval($_POST['limit_cap6']);
            }
            if (key_exists('limit_cap7', $_POST)) {
                $exptab['limit_cap7'] = intval($_POST['limit_cap7']);
            }
            if (key_exists('limit_cap8', $_POST)) {
                $exptab['limit_cap8'] = intval($_POST['limit_cap8']);
            }
            if (key_exists('limit_max', $_POST)) {
                $exptab['limit_max'] = intval($_POST['limit_max']);
            }
