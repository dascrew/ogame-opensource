...
// Cost of Officers.
$price = [ 1 => 10000, 2 => 10000, 3 => 10000, 4 => 10000, 5 => 10000 ];
...
if (key_exists('buynow', $_GET)) {
    $qcmd = [ 1 => QTYP_COMMANDER_OFF, 2 => QTYP_ADMIRAL_OFF, 3 => QTYP_ENGINEER_OFF, 4 => QTYP_GEOLOGE_OFF, 5 => QTYP_TECHNOCRATE_OFF ];
    ...
    if ($days == 7 || $days == 90) {
        ...
        if ($dm < $required) {
            ...
            if ($type >= 1 && $type <= 5) {
                // Списать ТМ.
                if ($GlobalUser['dm'] >= $required) {
                    $GlobalUser['dm'] -= $required;
                } else {
