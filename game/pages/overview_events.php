...
function OverFleet($fleet, $summary, $mission, $acs = false)
{
    ...
    if ($fleet['owner_id'] == $GlobalUser['player_id'] || $acs) {
        $level = 99;
    }
    global $fleetmap;
    $sum = 0;
...
function PlanetFrom($planet, $mission)
{
    ...
    if (GetPlanetType($planet) == 1) {
        $res .= loca('EVENT_FROM_PLANET');
    }
    if ($planet['type'] == PTYP_COLONY_PHANTOM || $planet['type'] == PTYP_FARSPACE) {
...
function FleetSpan($fleet_entry)
{
    ...
    if (0) {
    } elseif ($mission == FTYP_ATTACK) {            // Attack
        if ($dir == 0) {
            echo "<span class='flight ownattack'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownattack')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return ownattack'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownattack')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_RETURN_TO'), PlanetFrom($origin, 'ownattack'), PlanetTo($target, 'ownattack')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'ownattack', loca('EVENT_M_ATTACK')) . '</span>';
        } elseif ($dir == 0x10) {
            echo "<span class='attack'>" . va(loca('EVENT_FLEET_ENEMY'), OverFleet($fleet, 1, 'attack')) . "</a><a href='#' title='" . TitleFleet($fleet, 1) . "'></a>" .
    ...
    } elseif ($mission == FTYP_ACS_ATTACK) {            // ACS Attack
        if ($dir == 0) {
            echo "<span class='federation'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownfederation')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return ownfederation'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownfederation')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_RETURN_TO'), PlanetFrom($origin, 'ownfederation'), PlanetTo($target, 'ownfederation')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'ownfederation', loca('EVENT_M_ACS_ATTACK')) . '</span>';
        } elseif ($dir == 0x10) {
            echo "<span class='federation'>" . va(loca('EVENT_FLEET_ENEMY'), OverFleet($fleet, 1, 'federation')) . "</a><a href='#' title='" . TitleFleet($fleet, 1) . "'></a>" .
            ...
            echo "<span class='ownfederation'>" . va(loca('EVENT_FLEET_ACS_HEAD'), OverFleet($fleet, 1, 'ownfederation')) . "</a><a href='#' title='" . TitleFleet($fleet, 1) . "'></a>" .
                    va(loca('EVENT_PLAYER_FROM_TO'), PlayerDetails($owner), PlanetFrom($origin, 'ownfederation'), PlanetTo($target, 'ownfederation')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . loca('EVENT_M_ACS_ATTACK') . '</span>';
        }
    } elseif ($mission == FTYP_TRANSPORT) {            // Transport
        if ($dir == 0) {
            echo "<span class='flight owntransport'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owntransport')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return owntransport'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owntransport')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_RETURN_TO'), PlanetFrom($origin, 'owntransport'), PlanetTo($target, 'owntransport')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'owntransport', loca('EVENT_M_TRANSPORT')) . '</span>';
        } elseif ($dir == 0x10) {
            echo "<span class='flight transport'>" . va(loca('EVENT_FLEET_FRIEND'), OverFleet($fleet, 1, 'transport')) . "</a><a href='#' title='" . TitleFleet($fleet, 1) . "'></a>" .
    ...
    } elseif ($mission == FTYP_DEPLOY) {            // Deploy
        if ($dir == 0) {
            echo "<span class='flight owndeploy'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owndeploy')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return owndeploy'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owndeploy')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_TO'), PlanetFrom($origin, 'owndeploy'), PlanetTo($target, 'owndeploy')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'owndeploy', loca('EVENT_M_DEPLOY')) . '</span>';
        }
    } elseif ($mission == FTYP_ACS_HOLD) {            // ACS Hold
        if ($dir == 0) {
            echo "<span class='flight ownhold'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownhold')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return ownhold'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownhold')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_RETURN_TO'), PlanetFrom($origin, 'ownhold'), PlanetTo($target, 'ownhold')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'ownhold', loca('EVENT_M_HOLD')) . '</span>';
        } elseif ($dir == 2) {
            echo "<span class='holding ownhold'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownhold')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_HOLD_FROM_ONTO'), PlanetFrom($origin, 'ownhold'), PlanetFrom($target, 'ownhold')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'ownhold', loca('EVENT_M_HOLD')) . '</span>';
        } elseif ($dir == 0x20) {
            echo "<span class='flight hold'>" . va(loca('EVENT_FLEET_FRIEND'), OverFleet($fleet, 1, 'hold', true)) . "</a><a href='#' title='" . TitleFleet($fleet, 1, true) . "'></a>" .
            ...
            echo "<span class='holding hold'>" . va(loca('EVENT_FLEET_HOLD'), PlayerDetails($owner), OverFleet($fleet, 1, 'hold', true)) . "</a><a href='#' title='" . TitleFleet($fleet, 1, true) . "'></a>" .
                    va(loca('EVENT_FROM_TO_ORBIT'), PlanetFrom($origin, 'hold'), PlanetFrom($target, 'hold')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . loca('EVENT_M_HOLD') . '</span>';
        }
    } elseif ($mission == FTYP_SPY) {            // Espionage
        if ($dir == 0) {
            echo "<span class='flight ownespionage'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownespionage')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return ownespionage'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownespionage')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_RETURN_TO'), PlanetFrom($origin, 'ownespionage'), PlanetTo($target, 'ownespionage')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'ownespionage', loca('EVENT_M_SPY')) . '</span>';
        } elseif ($dir == 0x10) {
            echo "<span class='flight espionage'>" . va(loca('EVENT_FLEET_ENEMY'), OverFleet($fleet, 1, 'espionage')) . "</a><a href='#' title='" . TitleFleet($fleet, 1) . "'></a>" .
    ...
    } elseif ($mission == FTYP_COLONIZE) {            // Colonize
        if ($dir == 0) {
            echo "<span class='flight owncolony'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owncolony')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return owncolony'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owncolony')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_COLONY_FROM_RETURN_TO'), PlanetFrom($origin, 'owncolony'), PlanetTo($target, 'owncolony')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'owncolony', loca('EVENT_M_COLONY')) . '</span>';
        }
    } elseif ($mission == FTYP_RECYCLE) {            // Recycle
        if ($dir == 0) {
            echo "<span class='flight ownharvest'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownharvest')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return ownharvest'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownharvest')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_TO'), PlanetFrom($origin, 'ownharvest'), PlanetTo($target, 'ownharvest')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'ownharvest', loca('EVENT_M_RECYCLE')) . '</span>';
        }
    } elseif ($mission == FTYP_DESTROY) {            // Destroy
        if ($dir == 0) {
            echo "<span class='flight owndestroy'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owndestroy')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return owndestroy'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'owndestroy')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_RETURN_TO'), PlanetFrom($origin, 'owndestroy'), PlanetTo($target, 'owndestroy')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'owndestroy', loca('EVENT_M_DESTROY')) . '</span>';
        } elseif ($dir == 0x10) {
            echo "<span class='flight destroy'>" . va(loca('EVENT_FLEET_ENEMY'), OverFleet($fleet, 1, 'destroy')) . "</a><a href='#' title='" . TitleFleet($fleet, 1) . "'></a>" .
    ...
    } elseif ($mission == FTYP_ACS_ATTACK_HEAD) {            // ACS Attack Head fleet (slot 0)
        if ($dir == 0) {
            echo "<span class='attack'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownattack')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_FROM_TO'), PlanetFrom($origin, 'ownattack'), PlanetTo($target, 'ownattack')) .
            ...
            echo "<span class='ownattack'>" . va(loca('EVENT_FLEET_ACS_HEAD'), OverFleet($fleet, 1, 'ownattack')) . "</a><a href='#' title='" . TitleFleet($fleet, 1) . "'></a>" .
                    va(loca('EVENT_PLAYER_FROM_TO'), PlayerDetails($owner), PlanetFrom($origin, 'ownattack'), PlanetTo($target, 'ownattack')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . loca('EVENT_M_ACS_ATTACK_HEAD') . '</span>';
        }
    } elseif ($mission == FTYP_EXPEDITION) {            // Expedition
        if ($dir == 0) {
            echo "<span class='flight owntransport'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownexpedition')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
            ...
            echo "<span class='return owntransport'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownexpedition')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_EXPO_RETURN_FROM_TO'), PlanetTo($target, 'ownexpedition'), Cargo($m, $k, $d, 'ownexpedition', loca('EVENT_M_EXPO'))) . '</span>';
        } elseif ($dir == 2) {
            echo "<span class='holding owntransport'>" . va(loca('EVENT_FLEET_OWN'), OverFleet($fleet, 0, 'ownexpedition')) . "</a><a href='#' title='" . TitleFleet($fleet, 0) . "'></a>" .
                    va(loca('EVENT_EXPO_FROM_ONTO'), PlanetFrom($origin, 'ownexpedition'), PlanetFrom($target, 'ownexpedition')) .
                    '. ' . loca('EVENT_MISSION') . ': ' . Cargo($m, $k, $d, 'ownexpedition', loca('EVENT_M_EXPO')) . '</span>';
        }
    } elseif ($mission == FTYP_MISSILE) {          // Missile attack
        if ($dir == 0) {
        ...
        if ($fleet_entry['ipm_target'] > 0) {
            echo loca('EVENT_RAK_TARGET') . ' ' . loca('NAME_' . $fleet_entry['ipm_target']);
        }
        echo '</span>';
    } else {
        echo loca('EVENT_MISSION') . " Type:$mission, Dir:$dir, Fleet: " . TitleFleet($fleet, 0) . ', from ' . PlanetFrom($origin, '') . ' to ' . PlanetTo($target, '') . ', ' . Cargo($m, $k, $d, '', 'Cargo');
    }
}

function GetMission($fleet_obj)
{
    if ($fleet_obj['mission'] < FTYP_RETURN) {
        return $fleet_obj['mission'];
    } elseif ($fleet_obj['mission'] < FTYP_ORBITING) {
        return $fleet_obj['mission'] - FTYP_RETURN;
    } else {
        return $fleet_obj['mission'] - FTYP_ORBITING;
    }
}
...
function GetDirectionAssignment($friendly, $fleet_obj, &$dir, &$assign)
{
    ...
    if ($fleet_obj['owner_id'] == $GlobalUser['player_id']) {
        ...
        if ($friendly && (GetMission($fleet_obj) == FTYP_ACS_HOLD || GetMission($fleet_obj) == FTYP_ACS_ATTACK_HEAD || GetMission($fleet_obj) == FTYP_ACS_ATTACK)) {
            $assign = 2;
        } else {
            $assign = 1;
        }
...
function EventList()
{
    ...
    while ($rows--) {
        ...
        if (($fleet_obj['mission'] < FTYP_RETURN || $fleet_obj['mission'] > FTYP_ORBITING) && $fleet_obj['owner_id'] == $GlobalUser['player_id'] && $fleet_obj['mission'] != FTYP_DEPLOY && $fleet_obj['mission'] != FTYP_MISSILE) {
            ...
            if (GetMission($fleet_obj) == FTYP_ACS_HOLD || GetMission($fleet_obj) == FTYP_EXPEDITION) {
                if ($fleet_obj['mission'] > FTYP_ORBITING) {
                    $task[$tasknum]['end_time'] = $task[$tasknum]['start_time'] + $fleet_obj['deploy_time'];
                } else {
    ...
    if ($tasknum > 0) {
        ...
        foreach ($task as $i => $t) {
            ...
            if ($t['fleets'] > 1) {
                echo "<tr class=''>\n";
            } elseif ($t['fleet'][0]['dir'] == 0) {
                echo "<tr class='flight'>\n";
            } elseif ($t['fleet'][0]['dir'] == 1) {
                echo "<tr class='return'>\n";
            } elseif ($t['fleet'][0]['dir'] == 2) {
